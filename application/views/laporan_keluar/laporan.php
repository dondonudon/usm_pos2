            ...
            <div class="col-xs-12">
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-body">
                        ...
                        <form target="_blank" action="<?php base_url();?>laporan_keluar/report" method="post">
                            <input type="hidden" name="tanggal_a" id="tanggal_a">
                            <input type="hidden" name="tanggal_b" id="tanggal_b">
                            <button type="submit" class="btn btn-success">Print</button>
                        </form><br>
                        <table id="table" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <!-- <th>Nota</th> -->
